...
<body>
    <h2 class="text-muted m-3">ユーザー登録画面</h2>
    ...
    <form action="register.php" method="POST">
        ...
        <div class="form-check m-3">
            <p>
                ...
                <input class="m-3" type="checkbox" name="manager" value=1>管理者
                <input class="m-3" type="checkbox" name="manager" value=0>それ以外
            </p>
        </div>
        <input type="hidden" name="csrf_token" value="<?php echo h(setToken()) ?>">
        <p>
            <input type="submit" value="新規登録" class="form-control w-25 m-3">
        </p>
